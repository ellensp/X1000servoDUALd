...
#endif    _delay_us(3U); // wait 3 microseconds
...
#ifdef ULTIPANEL
#define MANUAL_FEEDRATE {50*60, 50*60, 4*60, 60, 60}  // set the speeds for manual moves (mm/min)
#endif
...
//adds support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENTCHANGEENABLE
    ...
    #define FILAMENTCHANGE_XPOS 175
    #define FILAMENTCHANGE_YPOS 25
