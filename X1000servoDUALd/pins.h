...
#define HEATER_BED_PIN    6// 20  // Bed
...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define Z_MAX_PIN          -1
	#define PAUSE_PIN          44
     // #define FEED_PIN           11 // used in conjuction with the filament feed sensor (rotary encoder)
	#define BED_INDICATOR_PIN          5 // used for lighting a warning LED when the bed is >= 70C
      #define BED_THERMISTOR_PIN         3
    ...
    #define LED_PIN            5
  #endif
// THIS IS WHERE I MADE CHANGES FOR 2X 1 FAN
  ...
  #if MOTHERBOARD == 35
    #define HEATER_BED_PIN     6    // NO BED
  #else
    #if MOTHERBOARD == 77
      #define HEATER_BED_PIN     9    // BED
    #else
      #define HEATER_BED_PIN     6   // BED D6 ERIC'S CUSTOM BED CONTROL SCHEME
    #endif
  #endif
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define BTN_EN1 42  // 22 reverse if the encoder turns the wrong way.
        #define BTN_EN2 40 //
        #define BTN_ENC -1
        #define SDSS 53
        #define SDCARDDETECT 49
...
#define KILL_PIN           4
  ...
  #define HEATER_BED_PIN   6    // RAMPS 1.0
  #define FAN_PIN          11    // RAMPS 1.0
#else // RAMPS_V_1_1 or RAMPS_V_1_2
  #define HEATER_0_PIN     10    // RAMPS 1.1
  #define HEATER_BED_PIN    6    // RAMPS 1.1
...
#define HEATER_BED_PIN     -1//44	//DOUBLE 12V PWM
...
#define MOTOR_CURRENT_PWM_XY_PIN -1//44
...
#define FAN_PIN            10 // IO pin. Buffer needed WAS 7
#define PS_ON_PIN          12
#define KILL_PIN           -1

#define HEATER_0_PIN       9    // EXTRUDER 1
#define HEATER_1_PIN       8    // EXTRUDER 2 (FAN On Sprinter) MB34??
#define HEATER_2_PIN       -1
...
#define TEMP_1_PIN         15   // ANALOG NUMBERING
#define TEMP_2_PIN         -1   // ANALOG NUMBERING
#define HEATER_BED_PIN     -1   // BED  this could be changed to fan????? WAS 10
#define TEMP_BED_PIN       14   // ANALOG NUMBERING
