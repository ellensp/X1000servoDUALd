...
#define MSG_ENDSTOPS_HIT                    "endstops active: "
#define MSG_ERR_COLD_EXTRUDE_STOP           " cold extrusion prevented"
#define MSG_ERR_LONG_EXTRUDE_STOP           " too long extrusion prevented"
#define MSG_BABYSTEPPING_X                  "Babystepping X CW+"
#define MSG_BABYSTEPPING_Y                  "Babystepping Y CW+"
#define MSG_BABYSTEPPING_Z                  "Babystepping Z CW+"
